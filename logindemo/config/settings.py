...
AUTH_PASSWORD_VALIDATORS = [
    {
        'NAME': 'users.validators.CustomStrictUserAttributeSimilarityValidator',
    },
    {
    ...
    {
        'NAME': 'users.validators.CustomUppercaseValidator', 
    },
    {
        'NAME': 'users.validators.CustomSymbolValidator', 
    },
]
